...
plt.plot(x, m_max*x + c_max, color='red', lw = 1, ls='--', label=f'Worst fit (Max): $B = {m_max:.3f}T + {c_max:.1f}$')
plt.plot(x, m_min*x + c_min, color='green', lw = 1, ls='--', label=f'Worst fit (Min): $B = {m_min:.3f}T + {c_min:.1f}$')
